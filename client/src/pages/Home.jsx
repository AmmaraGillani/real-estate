    ...
    <div>
      ...
      <div className='flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto'> 
        ...
        <div className='text-gray-400 text-xs sm:text-sm'>
            Gillani Estate is the best place to find your next 
      ...
      <Swiper navigation>
        {
          ...
          offerListings.map((listing) => (
            <SwiperSlide>
              <div style={{background : `url(${listing.imageUrls
              [0]}) center no-repeat`, backgroundSize:'cover'}} className='h-[500px]' key={listing._id}>
